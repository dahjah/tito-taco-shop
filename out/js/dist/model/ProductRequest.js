...
var ProductRequest = /*#__PURE__*/function () {
   ...
   */
  function ProductRequest(name, image, price, description) {
    _classCallCheck(this, ProductRequest);
    ProductRequest.initialize(this, name, image, price, description);
  }
   ...
   */
  return _createClass(ProductRequest, null, [{
    key: "initialize",
    value: function initialize(obj, name, image, price, description) {
      obj['name'] = name;
      obj['image'] = image;
      obj['price'] = price;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('image')) {
          obj['image'] = _ApiClient["default"].convertToType(data['image'], File);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ProductRequest.RequiredProperties),
        _step;
      try {
...
ProductRequest.RequiredProperties = ["name", "image", "price", "description"];
 ...
 * @member {File} image
 */
ProductRequest.prototype['image'] = undefined;

/**
 * @member {Number} price
 */
ProductRequest.prototype['price'] = undefined;
 ...
 */
ProductRequest.prototype['general_stock'] = undefined;
var _default = exports["default"] = ProductRequest;